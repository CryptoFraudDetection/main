...
def test_initialization():
    ...
    username = "test_user"
    password = "test_pass"
    scraper_with_credentials = TwitterScraper(username=username, password=password, logger=logger)
...
def test_scrape_with_cookies():
    ...
    tweets_data = scraper.scrape_with_cookies(tweet_count=1, search_query="Bitcoin", headless=True)
