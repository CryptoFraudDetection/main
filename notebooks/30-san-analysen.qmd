...
grouped_comments_df["fraud_ratio"] = (
    grouped_comments_df["fraud"] / grouped_comments_df["weight"]
)

# Display top edges
cols = {"weight", "score", "fraud_ratio"} | set(patterns.keys())
for column in cols:
...
grouped_posts_df["post_fraud_ratio"] = (
    grouped_posts_df["post_fraud"] / grouped_posts_df["post_count"]
)
