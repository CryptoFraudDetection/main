...
multirocket_all_data.fit(X_train, y_train)

X_transformed_train = multirocket_all_data.transform(X_train)
...
rf_all_data.fit(X_transformed_train_scaled, y_train)

train_predictions = rf_all_data.predict(X_transformed_train_scaled)
...
X_transformed_test = multirocket_all_data.transform(X_test)
...
test_predictions = rf_all_data.predict(X_transformed_test_scaled)
